      ...
      <div className="container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2.5">
              <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-slate-900 font-bold text-lg">
                R
              </div>
              <div>
                <p className="font-bold text-white leading-tight">Rishi Care</p>
                <p className="text-xs text-slate-400 leading-tight">Hospital</p>
              </div>
            </div>
            <p className="text-sm text-slate-400 leading-relaxed">
              Premium healthcare delivered with compassion. Trusted by thousands of families in Hyderabad.
            </p>
            <div className="flex gap-2 pt-1">
              <a
                href={`tel:${hospitalInfo.phone}`}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 rounded-lg text-sm font-medium transition-colors"
              >
                📞 Call
              </a>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-green-600 hover:bg-green-700 rounded-lg text-sm font-medium transition-colors"
              >
                💬 WhatsApp
              </a>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <p className="text-slate-400 leading-relaxed">{hospitalInfo.address}</p>
              </div>
              <div>
                <p className="font-medium text-white mb-0.5">Phone</p>
                <a href={`tel:${hospitalInfo.phone}`} className="text-slate-400 hover:text-white transition-colors">
                  {hospitalInfo.phone}
                </a>
              </div>
              <div>
                <p className="font-medium text-white mb-0.5">Email</p>
                <a href={`mailto:${hospitalInfo.email}`} className="text-slate-400 hover:text-white transition-colors break-all">
                  {hospitalInfo.email}
                </a>
              </div>
            </div>
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <p className="text-sm text-slate-500">
            © {currentYear} Rishi Care Hospital. All rights reserved.
          </p>
